...
var render = function () {
  ...
  return _c("div", {
    ...
    on: {
      click: function ($event) {
        $event.stopPropagation();
        return _vm.expandOrCollapseNode.apply(null, arguments);
      }
    }
  ...
  }, [!(_vm.graphSetting.hideNodeContentByZoom === true && _vm.graphSetting.canvasZoom < 40) ? [_vm._t("node", function () {
    return [!_vm.nodeProps.innerHTML ? _c("div", {
